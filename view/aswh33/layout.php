...
<head>
	...
	<link rel="stylesheet" href="/view/aswh33/yn/yn.css">
	<script src="//cdnjs.cloudflare.com/ajax/libs/mdui/0.4.1/js/mdui.min.js"></script>
	<script src="/view/aswh33/yn/yn.js"></script>
	<style>
...
<body class="mdui-theme-primary-blue-grey mdui-theme-accent-blue" id="mainbody" onresize="bdchange()">
	<header class="mdui-appbar mdui-color-theme" style="opacity:0.8">
