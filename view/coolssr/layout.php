...
<head>
	...
	<link rel="shortcut icon" href="/view/coolssr/favicon.ico" type="image/x-icon" />
	<link rel="stylesheet" href="//cdnjs.loli.net/ajax/libs/mdui/0.4.1/css/mdui.css">
	<link rel="stylesheet" href="/view/coolssr/css/style.css">
	<style>
		body {
	...
	<style>
		body {
			background-image: url(/view/coolssr/bj.jpg) !important;
...
<body class="mdui-theme-primary-blue-grey mdui-theme-accent-blue">
	...
	<script src="/view/coolssr/js/urusai.js" async></script>
